...
public class WisdomHUDRoundView extends RelativeLayout {
    ...
    public WisdomHUDRoundView(Context context) {
        super(context);
    ...
    public WisdomHUDRoundView(Context context, AttributeSet attrs) {
        super(context, attrs);
